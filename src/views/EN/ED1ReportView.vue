<template>
  <div class="relative mx-auto min-w-[320px]">
    <section
      class="flex flex-col flex-nowrap items-center justify-center lg:top-0 lg:left-0 lg:w-[100vw] lg:max-w-[100vw] lg:flex-row"
    >
      <!-- DESCRIPTION AREA -->
      <div
          ...
          >
            ...
            <template #additional-text>
              <span class="mb-20 text-14 text-gray-450"
                >*Please reply to the confirmation email with any additional
                files that we need to be aware of.</span
              >
            </template>
            ...
            <template #after-submit-text>
              <div class="w-[300px] text-center text-gray-700">
                <span class="mb-30 text-18"
                  >You must complete payment through the link in the
                  confirmation email.
                </span>
                <span class="text-18"

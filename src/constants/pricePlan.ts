export const PRICE_PLAN_CONTENT = [
  ...
  { content: 'Instantly get 3 feasibility studies.', level: 1 },
  { content: 'Unlock profit and profit assumptions.', level: 2 },
  { content: 'Generate up to 50,000 Solutions', level: 3 },

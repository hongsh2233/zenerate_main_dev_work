      ...
      >
        ...
        <div class="content-item">
          ...
          <p class="content-item-subtitle">
            이 직무는 데이터와 AI 기반의 웹 어플리케이션 프로덕트에 쓰이는 데이터 퀄리티를 관리하고, 지속적인 에러 트래킹과 프로세스 개선, 업무 자동화를 함께 기획하고 문제를 해결해나가는 역할입니다. 구체적으로는 하단 업무 중 일부를 수행하게 됩니다.
          </p>
          <ul class="content-item-content">
            <li>프로덕트에 사용되는 미국 건물 인허가(city planning entitlement & permit)와 관련한 데이터 digitization 업무 수행</li>
        ...
        <div class="content-item">
          ...
          <ul class="content-item-content">
            ...
            <li>주기적으로 업데이트 되는 제품에서 데이터 품질 관리와 프로세스 개선 경험이 있으신 분</li>
          </ul>
        </div>
        <div class="content-item">
          <div class="content-item-title">혜택, 복지, 업무 환경</div>
          <ul class="content-item-content">
            <li>업무 시간을 자율적으로 운영하는 유연근무제 (코어타임 : 10-17시)</li>
        ...
        <div class="content-item">
          ...
          <ul class="content-item-content">
            ...
            <li>서류전형의 이력서, 포트폴리오는 양식 제한 없이 자유롭게 제출해주세요.</li>
            <li>서류 합격시 접수 1주일 내에 개별 연락 드리겠습니다.</li>
            <li>제출 및 문의사항은 hkang@zenerate.ai 로 메일 남겨주시기 부탁드립니다 :)</li>
          </ul>
        </div>

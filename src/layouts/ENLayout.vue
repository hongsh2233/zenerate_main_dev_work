<template>
  <div class="layout-en" id="layout-en">
    ...
    <transition name="fade">
      ...
      >
        <div class="w-[296px] h-auto flex flex-col items-center px-28 pt-46">
          <p class="text-m-20-light text-primary mb-32 md:mb-34 lg:mb-50">
            <span class="text-m-20-semibold"> Try Zenerate </span>
            for free
          </p>
